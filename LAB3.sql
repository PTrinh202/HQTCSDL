  ...
  SELECT DCHI, LEFT(DCHI,CHARINDEX(' ',DCHI)) AS 'SỐ ĐƯỜNG'FROM NHANVIEN
  SELECT DCHI, LEFT(DCHI,CHARINDEX(' ',DCHI)) AS 'THÀNH PHỐ'FROM NHANVIEN
  SELECT DCHI, SUBSTRING(DCHI,CHARINDEX(' ',DCHI),LEN(DCHI)) AS 'THÀNH PHỐ'FROM NHANVIEN
  /**BÀI 4**/
